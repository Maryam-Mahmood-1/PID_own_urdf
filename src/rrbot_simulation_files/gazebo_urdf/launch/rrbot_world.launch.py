...
def generate_launch_description():
    ...
    gazebo_urdf = os.path.join(
        get_package_share_directory('gazebo_urdf'),
        'worlds',
        'rrbot.world')
    ...
    gazebo = IncludeLaunchDescription(
                ...
                launch_arguments={'world': gazebo_urdf}.items(),
             )

    urdf_desc_path = os.path.join(
        get_package_share_directory('urdf_desc'))

    xacro_file = os.path.join(urdf_desc_path,
                              'urdf',
                              'four_dof.urdf.xacro')
    ...
    robot_controllers = os.path.join(get_package_share_directory("gazebo_urdf"),"config","gazebo_controllers.yaml")
